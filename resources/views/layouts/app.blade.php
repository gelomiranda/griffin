...
<head>
  ...
  <link href="{{ URL::asset('public/css/fileinput.min.css')}}" media="all" rel="stylesheet" type="text/css" />
  ...
  <script src="{{ URL::asset('public/js/plugins/canvas-to-blob.min.js')}}" type="text/javascript"></script>
  <!-- sortable.min.js is only needed if you wish to sort / rearrange files in initial preview.
       This must be loaded before fileinput.min.js -->
  <script src="{{ URL::asset('public/js/plugins/sortable.min.js')}}" type="text/javascript"></script>
  <!-- purify.min.js is only needed if you wish to purify HTML content in your preview for HTML files.
       This must be loaded before fileinput.min.js -->

  <script src="{{ URL::asset('public/js/plugins/purify.min.js')}}" type="text/javascript"></script>
  <!-- the main fileinput plugin file -->
  <script src="{{ URL::asset('public/js/fileinput.min.js')}}"></script>
